...
class DES {
       ...
       public String toString() {
    	   System.out.println("Key after initial permutation: " + KeyMessage.toUpperCase());
   System.out.println(
       "Key after splitting: L0="
      + KeyMessage.substring(0, 8).toUpperCase()
      + " R0="
      + KeyMessage.substring(8, 16).toUpperCase()
       + "\n");
   				return KeyMessage;
       }
